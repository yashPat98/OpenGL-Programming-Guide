// ------------------------
// Name :        Yash Patel
// Assignment :  Multiple Lights Assignment
// Date :        23-11-2020
// ------------------------
...
bool gbDirectionalLight = false;
bool gbSpotLight        = false;
        ...
        case WM_CHAR:
            switch(wParam)
            {
                ...
                case 'D':
                    ...
                    {
                        glDisable(GL_LIGHT0);
                        gbDirectionalLight = false;
                    }
                    else
                    {
                        glEnable(GL_LIGHT0);
                        gbDirectionalLight = true;
                    }
                    break;
...
void Initialize(void)
{
    ...
    //variable declaration
    GLfloat lightPos0[]           = {1.0f, 1.0f, 1.0f, 0.0f};       //directional light
    GLfloat lightPos1[]           = {-1.0f, 1.0f, 1.0f, 1.0f};      //positional light
    GLfloat spotDir[]             = {0.0f, 0.0f, -1.0f};

    GLfloat lightModelAmbient[]   = {0.1f, 0.1f, 0.1f, 1.0f};
    GLfloat whiteLight[]          = {1.0f, 1.0f, 1.0f, 1.0f};
    GLfloat ambientLight1[]       = {0.2f, 0.2f, 0.2f, 1.0f};
    GLfloat diffuseLight1[]       = {0.2f, 0.2f, 1.0f, 1.0f};
    GLfloat specularLight1[]      = {0.2f, 0.2f, 1.0f, 1.0f};
