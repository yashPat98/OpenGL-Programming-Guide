// ------------------------
// Name :        Yash Patel
// Assignment :  Line Stipple Assignment 
// Date :        10-11-2020
// ------------------------
...
void Resize(int width, int height)
{
    ...
    gluOrtho2D(50.0, 350.0, 150.0, 0.0);
}
...
void Display(void)
{
    ...
    {
        glBegin(GL_LINES);
            glVertex2f(50.0f + ((GLfloat)i * 50.0f), 50.0f);
            glVertex2f(50.0f + ((GLfloat)(i + 1) * 50.0f), 50.0f);
        glEnd();
    }
