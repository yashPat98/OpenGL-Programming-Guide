// ------------------------
// Name :        Yash Patel
// Assignment :  Torus using Display lists 
// Date :        27-11-2020
// ------------------------
...
void Initialize(void)
{
    ...
    //create display list with torus
        ...
        glBegin(GL_QUAD_STRIP);
            for(j = 0; j <= numt; j++)
            {
                for(k = 1; k >= 0; k--)
                {
                    ...
                    x = (1 + 0.1f * cos(s * twopi / numc)) * cos(t * twopi / numt); 
                    y = (1 + 0.1f * cos(s * twopi / numc)) * sin(t * twopi / numt);
                    z = 0.1f * sin(s * twopi / numc);
