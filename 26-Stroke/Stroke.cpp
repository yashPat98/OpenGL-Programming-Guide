// ------------------------
// Name :        Yash Patel
// Assignment :  Multiple display lists to define stroked font  
// Date :        26-11-2020
// ------------------------
...
CP Adata[] = {
    {0.0f, 0.0f, PT}, {0.0f, 9.0f, PT}, {1.0f, 10.0f, PT}, {4.0f, 10.0f, PT},
    {5.0f, 9.0f, PT}, {5.0f, 0.0f, STROKE}, {0.0f, 5.0f, PT}, {5.0f, 5.0f, END}
};

CP Edata[] = {
    {5.0f, 0.0f, PT}, {0.0f, 0.0f, PT}, {0.0f, 10.0f, PT}, {5.0f, 10.0f, STROKE},
    {0.0f, 5.0f, PT}, {4.0f, 5.0f, END}
};

CP Pdata[] = {
    {0.0f, 0.0f, PT}, {0.0f, 10.0f, PT}, {4.0f, 10.0f, PT}, {5.0f, 9.0f, PT},
    {5.0f, 6.0f, PT}, {4.0f, 5.0f, PT}, {0.0f, 5.0f, END}
};

CP Rdata[] = {
    {0.0f, 0.0f, PT}, {0.0f, 10.0f, PT}, {4.0f, 10.0f, PT}, {5.0f, 9.0f, PT},
    {5.0f, 6.0f, PT}, {4.0f, 5.0f, PT}, {0.0f, 5.0f, STROKE}, {3.0f, 5.0f, PT}, 
    {5.0f, 0.0f, END}
};
