        ...
        case WM_CHAR:
            switch(wParam)
            {
                ...
                case 'M':
                    ...
                    {
                        fogMode = GL_EXP2;
                        SetWindowText(ghwnd, TEXT("OpenGL : Fog     Mode : GL_EXP2"));
                    }
                    else if(fogMode == GL_EXP2)
                    {
                        fogMode = GL_LINEAR;
                        SetWindowText(ghwnd, TEXT("OpenGL : Fog     Mode : GL_LINEAR"));
                    }
                    else if(fogMode == GL_LINEAR)
                    {
                        fogMode = GL_EXP;
                        SetWindowText(ghwnd, TEXT("OpenGL : Fog     Mode : GL_EXP"));
                    }
...
void Initialize(void)
{
    ...
    //variable declaration
    GLfloat lightPos0[]    = {0.5f, 0.5f, 3.0f, 0.0f};
    GLfloat matAmbient[]   = {0.1745f, 0.01175f, 0.01175f};
    GLfloat matDiffuse[]   = {0.61424f, 0.04136f, 0.04136f};
    GLfloat matSpecular[]  = {0.727811f, 0.626959f, 0.626959f};
    GLfloat fogColor[4]    = {0.5f, 0.5f, 0.5f, 1.0f};

    //set clearing color to fog color
