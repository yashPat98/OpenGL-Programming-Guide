// ------------------------
// Name :        Yash Patel
// Assignment :  Clipping Planes Assignment 
// Date :        17-11-2020
// ------------------------
...
{
    //variable declaration
    static GLfloat sphereRot = 0.0f;
    GLdouble eqn1[4] = {0.0f, 1.0f, 0.0f, 0.0f};
    GLdouble eqn2[4] = {1.0f, 0.0f, 0.0f, 0.0f};
    ...
    glPushMatrix();
        ...
        glRotatef(sphereRot, 0.0f, 1.0f, 0.0f);
